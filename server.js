...
const R2_BUCKET_PREFIX = process.env.R2_BUCKET_PREFIX || 'photos/';
const R2_PUBLIC_BASE_URL = process.env.R2_PUBLIC_BASE_URL || (R2_ACCOUNT_ID && R2_BUCKET_NAME ? `https://${R2_ACCOUNT_ID}.r2.cloudflarestorage.com/${R2_BUCKET_NAME}` : null);
